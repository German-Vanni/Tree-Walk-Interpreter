...
import  static me.germanvanni.jlox.TokenType.*;
public class Parser {
    ...
    private Expr call(){
        ...
        while(true){
            if(match(LEFT_PAREN)){
                ...
                Token name = consume(IDENTIFIER, "Epected property name after '.'.");
    ...
    private void synchronize(){
        ...
        while(!isAtEnd()){
            ...
            //a simple way to sync is to find a "boundary statement"
            switch(peek().type){
                case CLASS:
                case FN:
                case VAR:
